...
const GeminiLogo = () => (
  <div className="flex items-center gap-2 text-[28px] font-semibold tracking-tight text-slate-800 transition-all duration-300 hover:opacity-100 dark:text-white dark:opacity-90">
...
const ReactLogo = () => (
  <div className="flex items-center gap-3 text-[28px] font-bold tracking-tight text-slate-800 transition-all duration-300 hover:opacity-100 dark:text-white dark:opacity-90">
...
const FirebaseLogo = () => (
  <div className="flex items-center gap-2 text-[28px] font-bold tracking-tight text-slate-800 transition-all duration-300 hover:opacity-100 dark:text-white dark:opacity-90">
...
export function TechnologySection() {
  return (
    <section id="built-with" className="overflow-hidden bg-white py-16 dark:bg-[#0a0f0d]">
      <div className="group relative m-auto max-w-6xl px-6">
        <div className="flex flex-col items-center md:flex-row">
          {/* Left Text Column */}
          <div className="mb-6 md:mb-0 md:max-w-48 md:border-r border-[#dbe9d5] md:pr-8 dark:border-white/10">
          ...
          <div className="relative w-full py-4 md:w-[calc(100%-12rem)] [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] [mask-repeat:no-repeat] [mask-size:100%_100%]">
