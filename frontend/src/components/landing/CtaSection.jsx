...
export function CtaSection() {
  return (
    <section className="bg-slate-50 px-4 py-20">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-emerald-950 px-6 py-12 text-white shadow-soft sm:px-10 lg:px-14">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <div className="mb-5 flex w-fit items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-sm text-emerald-100">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            <Button size="lg" className="h-12 rounded-xl bg-white px-6 text-emerald-950 hover:bg-emerald-50">
              Request Access
