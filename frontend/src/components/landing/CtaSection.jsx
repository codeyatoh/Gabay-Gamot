...
export function CtaSection() {
  return (
    <section className="bg-slate-50 px-4 py-20">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-slate-900 px-6 py-12 text-white shadow-soft sm:px-10 lg:px-14">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-teal-50/75 sm:text-base">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            <Button size="lg" className="h-12 rounded-xl bg-white px-6 text-slate-900 hover:bg-teal-50">
              Request Access
