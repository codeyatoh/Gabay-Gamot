...
export function CtaSection() {
  return (
    <section className="bg-slate-50 px-4 py-14 sm:px-6 sm:py-16 md:px-8 lg:py-20">
      <div className="mx-auto w-full max-w-screen-xl overflow-hidden rounded-2xl bg-[#083f24] px-5 py-10 text-white shadow-soft sm:px-8 sm:py-12 lg:px-12 xl:px-14">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:w-48 lg:flex-col">
            <Button asChild size="lg" className="h-12 rounded-xl bg-white px-6 text-slate-900 hover:bg-[#eef8e9]">
              <a href="/signup">
                Request Access
                <ArrowRight className="h-4 w-4" />
              </a>
            </Button>
            <Button asChild size="lg" variant="outline" className="h-12 rounded-xl border-white/20 bg-transparent px-6 text-white hover:bg-white/10 hover:text-white">
