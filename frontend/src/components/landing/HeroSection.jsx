...
export function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden bg-[linear-gradient(180deg,#f8fffc_0%,#ffffff_70%)]">
      <div className="section-shell grid min-h-[calc(100vh-4rem)] items-center gap-14 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:py-20">
        <div className="max-w-2xl reveal">
          <Badge className="mb-6 rounded-full border-emerald-200 bg-white px-3 py-1 text-emerald-700 shadow-sm">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Button size="lg" className="h-12 rounded-xl bg-emerald-600 px-6 text-white shadow-panel hover:bg-emerald-700">
              Get Started
