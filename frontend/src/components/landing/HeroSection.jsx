        ...
        <div className="mx-auto flex w-full max-w-7xl justify-center">
          <div className="flex max-w-5xl flex-col items-center text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Button
                variant="secondary"
                className="h-12 rounded-md border border-slate-300 bg-white/90 px-7 font-mono text-xs uppercase tracking-normal text-[#083f24] shadow-sm backdrop-blur-md hover:bg-slate-50 dark:border-white/20 dark:bg-black/50 dark:text-slate-200 dark:hover:bg-black/70 sm:px-8 md:h-14 md:px-10"
              >
