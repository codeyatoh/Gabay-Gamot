      ...
      <div className="section-shell">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <Card
              key={feature.title}
              className="reveal group rounded-2xl border-white bg-white p-6 shadow-none transition duration-300 hover:-translate-y-1 hover:border-emerald-100 hover:shadow-panel"
              style={{ animationDelay: `${index * 70}ms` }}
            >
              <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-700 transition duration-300 group-hover:bg-emerald-600 group-hover:text-white">
