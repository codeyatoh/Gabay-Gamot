...
- Separate permissions for Super Admin/System Owner, Barangay Health Center Admin, and Barangay Health Worker.
- Public admin signup must create an approval request only. It must not immediately create an active Firebase Auth account.
- A Super Admin/System Owner must verify barangay health center legitimacy and approve the request before an Admin receives a temporary password.

## Authorization

Use role-based access control.

Barangay Health Center Admin can:
...
- review barangay health center admin signup requests
- verify proof/authorization documents
- approve or reject barangay health center admin requests
- create or activate barangay health center admin accounts
